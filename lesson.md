...
Colab runs in a Linux environment and comes with many popular Python libraries pre-installed. You can also install additional libraries using `pip` commands. It is a great tool for learning and experimenting with data science and machine learning. Read more about it in [Self Studies](./studies.md).
